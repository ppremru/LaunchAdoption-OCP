...
<br> [Official SNO Overview](https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/installing_on_a_single_node/index) |
...
| --- | --- | --- |
| Static IPs | Dedicated IP addresses for core infrastructure components. | One for Bastion <br>

<br> One for SNO Node |
| DNS Records | Resolvable records for api, api-int, and wildcard apps pointing to the same single node IP. | api <br>
...
| Admin Credentials | Red Hat Customer Portal ID and SSH Key Pair for node access. | Pull Secret <br>
