...
| --- | --- | --- |
| Static IPs | Dedicated IP addresses for core infrastructure components. | One for Bastion, One for SNO Node |
| DNS Records | Resolvable records pointing to the single node IP.  | `api, api-int, *.apps, registry-fqdn` |
